...
const writingPanelLeftPart7 = `
  ...
  <div style="text-align:center;">
    <img src="/images/ket32-1-color.png" alt="Part 7 - Câu 32" style="max-width:50%; height:auto; border:1px solid #ccc;"/>
    <img src="/images/ket32-2-color.png" alt="Part 7 - Câu 32" style="max-width:50%; height:auto; border:1px solid #ccc;"/>
    <img src="/images/ket32-3-color.png" alt="Part 7 - Câu 32" style="max-width:50%; height:auto; border:1px solid #ccc;"/>
  </div>
`;
...
const questions = [
  ...
  },
  {
    ...
    },
    {
      index: 7,
      part: 2,
      left: reading7_13, // hoặc nội dung bạn đang dùng
      right: part2Right,
      answer: "B"
    },
    {
